    ...
    <section id="gallery" class="clear">
      <figure>
        ...
        <figcaption>
			<section>
					<address>
					Software Engineering Group Semester V<br>
					Address       :Taleigao Plateau, Goa University<br>
					Town/City     :Panjim<br>
					Postcode/Zip  :403002<br>
					<br>
					Tel: 0832 - 2452113<br>
					Email: <a href="http://www.gmail.com">DCST@unigoa.com</a>
					</address>
			</section>
		</figcaption>
      </figure>
...
<div class="wrapper row3">
  <footer id="copyright" class="clear">
    ...
    <p class="fl_right"><a href="contactUs.jsp" title="Website Templates">DCST Goa University</a></p>
  </footer>
</div>
</body>
</html>