...
<div class="wrapper row2">
  <div id="container">
    ...
    <section id="gallery" class="clear">
      <figure>
        <header>Create an Auction </header>
       	<h4>Choose a product to create auction.</h4>
       	<%
       	...
       	%>
       		Product Name: <%=p.getProdname()%>&nbsp;&nbsp; <a href="createAuction.jsp?pid=<%=p.getProductId()%>">Create Auction</a><br>
       	<% 
      	 	i++; }
       	%>
...
<div class="wrapper row3">
  <footer id="copyright" class="clear">
    ...
    <p class="fl_right"><a href="sell.jsp" title="Website Templates">DCST Goa University</a></p>
  </footer>
</div>
</body>
</html>